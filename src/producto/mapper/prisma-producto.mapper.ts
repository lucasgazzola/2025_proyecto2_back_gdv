...
import { MarcaMapper } from '../../marca/mapper/prisma-marca.mapper';
import { CategoriaMapper } from '../../categoria/mapper/prisma-categoria.mapper';
import { ProveedorMapper } from '../../proveedor/mapper/prisma-proveedor.mapper';
  ...
  static toDomain(producto: any): Producto {
    return {
      ...
      categories: producto.categories
        ? producto.categories.map((c) => CategoriaMapper.toDomain(c))
        : [],
      providerId: producto.providerId,
      provider: producto.provider
        ? ProveedorMapper.toDomain(producto.provider)
        : undefined,
